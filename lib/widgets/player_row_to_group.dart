...
class PlayerRowToGroup extends StatefulWidget {
  final User userInRow;

  const PlayerRowToGroup({
    this.userInRow,
  });
  @override
  _PlayerRowToGroupState createState() => _PlayerRowToGroupState();
}

class _PlayerRowToGroupState extends State<PlayerRowToGroup> {
